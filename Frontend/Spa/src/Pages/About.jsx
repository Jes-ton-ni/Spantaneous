     ...
     <h1 className='text-[6rem] text-dark font-extrabold font-palanquin text-center'>About Us</h1>
      ...
      <section className='mx-auto'style={{backgroundImage: `url(${bg3})`}}>
         ...
         <div className="flex flex-wrap container justify-center  w-full gap-12 p-4 mx-auto " >
            ...
            <div className="w-[18rem] h-[20rem] max-sm:w-[20rem] max-sm:h-[20rem] bg-black hover:transform hover:scale-110 transition-transform duration-500 bg-center bg-cover rounded-[20px] border-2" style={{ backgroundImage: `url(${bg1})`}}></div>

            <div className="w-[18rem] h-[20rem] max-sm:w-[20rem] max-sm:h-[20rem] bg-black hover:transform hover:scale-110 transition-transform duration-500 bg-center bg-cover rounded-[20px] border-2" style={{ backgroundImage: `url(${bg2})`}}></div>
             </div>
            </div>
